			...
			aiImageBlcokEl(
				...
				aiImageBlcokEl(
					...
					aiImageBlcokEl( 'div',  { class: 'aiassist-select aiassist-image-model' },
						...
						addModel('midjourney', aiassist.info.labels.img_model_1_on, aiassist.info.labels.img_model_1, 'aiassist-option '+( ! [ 'basic', 'pro', 'premium' ].includes( aiassist.info.subscribe.type ) ? 'aiassist-lock' : '' ) ),
						addModel('dalle', aiassist.info.labels.img_model_2_on, aiassist.info.labels.img_model_2, 'aiassist-option '+( ! [ 'basic', 'pro', 'premium' ].includes( aiassist.info.subscribe.type ) ? 'aiassist-lock' : ''  ) ),
						addModel('gptImage', aiassist.info.labels.img_model_3_on, aiassist.info.labels.img_model_3, 'aiassist-option '+(  ! [ 'basic', 'pro', 'premium' ].includes( aiassist.info.subscribe.type ) ? 'aiassist-lock' : ''  ) ),
						addModel('gptMini', aiassist.info.labels.img_model_5_on, aiassist.info.labels.img_model_5, 'aiassist-option' ),
						addModel('banana', aiassist.info.labels.img_model_6_on, aiassist.info.labels.img_model_6, 'aiassist-option '+(  ! [ 'basic', 'pro', 'premium' ].includes( aiassist.info.subscribe.type ) ? 'aiassist-lock' : ''  ) ),
						addModel('grok', aiassist.info.labels.img_model_7_on, aiassist.info.labels.img_model_7, 'aiassist-option '+(  ! [ 'basic', 'pro', 'premium' ].includes( aiassist.info.subscribe.type ) ? 'aiassist-lock' : ''  ) ),
						addModel('input'),
					),
				),
