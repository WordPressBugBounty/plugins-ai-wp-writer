	...
	public function scripts(){
		...
		wp_localize_script('aiassist', 'aiassist', [ 
			...
			'locale'	=> [
				...
				'Generate meta title'	=> wp_kses_post( __('Generate meta title', 'wp-ai-assistant') ),
				'Meta description generation'	=> wp_kses_post( __('Meta description generation', 'wp-ai-assistant') ),
